...
@WebServlet("/admin-update-batch")
public class AdminUpdateBatchServlet extends HttpServlet {
    ...
    protected void doPost(
        ...
        try {
            ...
            if (success) {
                ...
                boolean feeUpdateSuccess =
                        studentFeeService.updatePendingFeesForBatch(
                                id,
                                monthlyFee
                        );
                ...
                if (!feeUpdateSuccess) {
                    ...
                    response.getWriter().print(
                            "{\"success\":false,\"message\":\"Batch updated, but pending fee records could not be updated\"}"
                    );
            ...
            response.getWriter().print(
                    "{\"success\":false,\"message\":\"Invalid batch ID or monthly fee\"}"
            );
